...
- [SpotifyManager](modules/spotifymanager.md)
- [SpotifyPlugin](modules/spotifyplugin.md)
- [abstract/Loader](modules/abstract_loader.md)
- [abstract/SpotifyItem](modules/abstract_spotifyitem.md)
...
- [item/SpotifyTrackLoader](modules/item_spotifytrackloader.md)
